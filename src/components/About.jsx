...
function About() {
    ...
    return <Box maxHeight='597px' pt={10}>
        <Container maxWidth="lg">
            <Box display='flex' flexDirection='row' flexBasis="30%" justifyContent='space-between' flexWrap='wrap' textAlign='justify'>
                <Box>
                    <img src={vector1} width="364px" height="208px" />
                    <Box component='h1' fontWeight={700} style={{ textShadow: '6px 4px 0px #FFB800', position: 'relative', color: '#171834', fontStyle: 'normal', fontWeight: 'bold', fontSize: '147px', bottom: '313px', left: '20px' }}>
